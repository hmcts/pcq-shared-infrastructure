locals {
  ...
  vnet_name    = var.env == "sbox" || var.env == "perftest" || var.env == "aat" || var.env == "ithc" ? "cft-${var_env}-vnet" : "core-${var.env}-vnet"
  vnet_resource_group_name = var.env == "sbox" || var.env == "perftest" || var.env == "aat" || var.env == "ithc" ? "cft-${var_env}-network-rg" : "aks-infra-${var.env}-rg"
